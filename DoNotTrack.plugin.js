/**
 * @name DoNotTrack
 * @description 停止Discord透過Sentry和Analytics追蹤你的所有活動。
 * @version 0.1.0
 * @author tintu.illumi.com
 * @authorId 472637182180458496
 * @website https://github.com/Izana7822/ILUMI
 * @source https://raw.githubusercontent.com/Izana7822/ILUMI/DoNotTrack.plugin.js
 */
/*@cc_on
@if (@_jscript)
...
const config = {
    info: {
        ...
        authors: [
            {
                name: "tintu.illumi.com",
                discord_id: "472637182180458496",
        ...
        version: "0.1.0",
        description: "停止Discord透過Sentry和Analytics追蹤你的所有活動。",
        github: "https://github.com/Izana7822/ILUMI",
        github_raw: "https://raw.githubusercontent.com/Izana7822/ILUMI/DoNotTrack.plugin.js"
    },
    changelog: [
        {
            title: "Fixes",
...
module.exports = !global.ZeresPluginLibrary ? Dummy : (([Plugin, Api]) => {
    ...
    return class DoNotTrack extends Plugin {
        ...
        enableProcessMonitor() {
            SettingsManager?.updateAsync("狀態", settings => settings.showCurrentGame = BoolSetting.create({value: true}));
            Modals.showConfirmationModal("重新加載Discord?", "若要重新啟用進程監控器，需要重新載入 Discord。", {
                confirmText: "重載",
                cancelText: "稍後",
